...
//const headsSection = document.getElementsByClassName("heads");
//const tailsSection = document.getElementsByClassName("tails");
...
flipButton.addEventListener("click", function(e) {
    ...
    setTimeout(function() {
        ...
        document.getElementById("coin").style.animation = "spin-heads 3s forwards";
        }, 100);
        heads++;  
    ...
    setTimeout(function() {
        document.getElementById("coin").style.animation = "spin-tails 3s forwards";
        }, 100);
        tails++;
